...
namespace DaprDebugger.Commands
{
	...
	///     Command handler
	/// </summary>
	internal sealed class StopDependencies
	{
		/// <summary>
		///     Command ID.
		/// </summary>
		...
		/// <summary>
		///     Initializes a new instance of the <see cref="StopDependencies" /> class.
		///     Adds our command handlers for menu (commands must exist in the command table file)
		/// </summary>
		/// <param name="package">Owner package, not null.</param>
		/// <param name="commandService">Command service to add command to, not null.</param>
		private StopDependencies(DaprDebuggerPackage package, OleMenuCommandService commandService)
		{
			...
			package.DaprDependencyManager.StopMenuItem = _menuItem;
		...
		/// </summary>
		public static StopDependencies Instance { get; private set; }
		...
		{
			await package.DaprDependencyManager.StopAsync();
		}
	}
}
